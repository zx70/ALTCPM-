/*
   ...
   This version has been manipulated to work with the ALTCPM version of the BDS C
	...
	int chan;
{
	...
	fprintf (chan, "  End of current L2 TPA: 0x%x\n", *tptr);
